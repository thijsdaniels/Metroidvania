...
{
    [Serializable]
    public class NineTile : MorphTile
    {
...
#if UNITY_EDITOR
        [MenuItem("Assets/Create/Scripted Tile/Nine Tile")]
        public static void CreateNineTile()
        {
            string path = EditorUtility.SaveFilePanelInProject("Save Nine Tile", "New Nine Tile", "asset", "Save Nine Tile", "Assets");
            ...
            AssetDatabase.CreateAsset(ScriptableObject.CreateInstance<NineTile>(), path);
        }
...
#if UNITY_EDITOR
    [CustomEditor(typeof(NineTile))]
    public class NineTileEditor : Editor
    {
        private NineTile tile { get { return (target as NineTile); } }
